...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/pornhub.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
	<title>pornhub</title>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/pornhub.php?query=1,o=bw,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
...
foreach($videos as $video) {
    ...
    $t3=explode("<",$t2[1]);
  	...
  	$link=$host."/scripts/adult/php/pornhub.php?query=1,".$link.",release";
  	if ($title) {
  	echo '
  	<item>
  		<title>'.$title.'</title>
