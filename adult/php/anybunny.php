...
if($query) {
   ...
   if ($tip == "release") {
      ...
      $search2 = $search."?p=".$page;
   } else {
     $search3=str_replace(" ","+",urldecode($search));
     //$search2="http://www.xnxx.com/?k=".$search3."&p=".$page;
     //$search2="https://www.xvideos.com/?k=".$search."&p=".($page-1);
     if ($page > 1)
     $search2="http://anybunny.com/new/".$search3."?p=".$page;
     else
     $search2="http://anybunny.com/new/".$search3;
     $tip="search";
   }
}
...
//echo $link;
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $search2);
...
foreach($videos as $video) {
    ...
    $t2 = explode("'", $t1[1]);
    $link =$t2[0];
    //$link = "anybunny_link.php?file=".$link."&title=".urlencode($title);
    ...
    $link = $host."/scripts/adult/php/anybunny_link.php?file=".$link;
