...
if($query) {
   ...
   if ($tip == "release") {
     ...
     $search2="http://www.madthumbs.com/search?q=".$search3."&p=".$page;
     $tip="search";
   }
}
if ($tip=="release") {
$link="http://www.madthumbs.com/videos/browse?p=".$page;
...
$videos = explode('class="thumb_container">', $html);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://www.madthumbs.com".$t2[0];
    ...
    $link = $host."/scripts/adult/php/madthumbs_link.php?file=".$link;


    $data = $title." ".trim(str_between($video,'class="al fl">','<'));
