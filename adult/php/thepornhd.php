...
$videos = explode('<div class="col-sm-6', $html);
//http://thepornhd.com/amateur/recent/2/
unset($videos[0]);
...
foreach($videos as $video) {
    ...
    $link = $host."/scripts/adult/php/thepornhd_link.php?file=".$link;
