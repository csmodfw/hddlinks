...
if($query) {
   ...
   if ($tip == "release") {
     ...
     if ($page>1)
     $search2="https://www.thumbzilla.com/video/search?q=".$search3."&page=".$page;
     else
     $search2="https://www.thumbzilla.com/video/search?q=".$search3;
     $tip="search";
   }
}
if ($tip=="release") {
  ...
  curl_setopt($ch, CURLOPT_REFERER, "https://www.thumbzilla.com");
...
foreach($videos as $video) {
    ...
    $t2=explode("<",$t1[1]);
    $title=$t2[0];
    $link = $host."/scripts/adult/php/thumbzilla_link.php?file=".$link;
