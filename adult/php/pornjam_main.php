...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host; ?>/scripts/adult/php/pornjam.php?query=1," + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
	<title>pornjam</title>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/pornjam.php?query=1,https://www.pornjam.com/,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
  	</item>';
$l="https://www.pornjam.com/categories/";
...
foreach($videos as $video) {
    ...
    $t1=explode("'",$t[1]);
    $link="https://www.pornjam.com".$t1[0];
  	$title=str_between($video,"title='","'");

  	$link=$host."/scripts/adult/php/pornjam.php?query=1,".$link.",release";
  	echo '
  	<item>
  		<title>'.$title.'</title>
  		<link>'.$link.'</link>
