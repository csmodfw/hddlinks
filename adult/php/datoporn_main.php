...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/datoporn.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
foreach($videos as $video) {
    ...
    $link=$t1[0]."/";
  	...
  	$link=$host."/scripts/adult/php/datoporn.php?query=1,".$link.",release";;
