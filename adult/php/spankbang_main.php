...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host; ?>/scripts/adult/php/spankbang.php?query=1," + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/spankbang.php?query=1,https://pl.spankbang.com/new_videos/,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
...
foreach($videos as $video) {
    ...
    $t1=explode('"',$t[1]);
    $link="https://www.pornburst.xxx".$t1[0];
  	$title=str_between($video,'title="','"');

  	$link=$host."/scripts/adult/php/pornburst.php?query=1,".$link.",release";
  	echo '
  	<item>
  		<title>'.$title.'</title>
  		<link>'.$link.'</link>
