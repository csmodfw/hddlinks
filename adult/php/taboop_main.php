...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/taboop.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
	<title>taboop</title>
...
foreach($videos as $video) {
    ...
    $link=$t1[0];
  	...
  	$link=$host."/scripts/adult/php/taboop.php?query=1,".$link.",release";
  	if ($title && preg_match("/(category\/|tag\/)/",$link)) {
  	echo '
  	<item>
  		<title>'.$title.'</title>
  		<link>'.$link.'</link>
