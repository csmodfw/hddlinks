...
if($query) {
   ...
   if ($tip == "release") {
     ...
     $search3=str_replace(" ","%20",urldecode($search));
     if ($page>1)
     $search2="http://fapbox.com/page".$page.".html?searchKey=".$search3."&category=videos";
     else
     $search2="http://fapbox.com/?searchKey=".$search3."&category=videos";
     $tip="search";
   }
}
//http://fapbox.com/page2.html?searchKey=mom%20son&category=videos
if ($tip=="release") {
  if ($page>1)
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $image = $t2[0];
    $link = $host."/scripts/adult/php/fapbox_link.php?file=".$link;
