...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host; ?>/scripts/adult/php/pornfree.php?query=1," + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
foreach($videos as $video) {
    ...
    $t4=explode("<",$t3[1]);
  	...
  	$link=$host."/scripts/adult/php/pornfree.php?query=1,".$link.",release";
  	echo '
  	<item>
  		<title>'.$title.'</title>
  		<link>'.$link.'</link>
