...
if ($tip=="release") {
if ($page > 1)
$search3 = $search."".$page."/";   //https://pl.spankbang.com/new_videos/2/
else
$search3 = $search;
...
$html=shell_exec($exec);
  ...
  $tip="search";
  //https://pl.spankbang.com/s/mom+son/
  //https://pl.spankbang.com/s/mom+son/2/
  $search1=str_replace(" ","+",urldecode($search));
  if ($page > 1)
  $search3="https://pl.spankbang.com/s/".$search1."/".$page."/";
  else
  $search3="https://pl.spankbang.com/s/".$search1;
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "https://pl.spankbang.com".$t2[0];
    ...
    $link = $host."/scripts/adult/php/spankbang_link.php?file=".$link;
    //http://img02.redtubefiles.com/_thumbs/0000350/0350855/0350855_009m.jpg
