...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/youporn.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<script>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/youporn.php?query=1,https://www.youporn.com/,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
...
$videos = explode("class='sublist-item", $html);
unset($videos[0]);
...
foreach($videos as $video) {
    ...
    $t3=explode("<",$t2[1]);
  	...
  	$link=$host."/scripts/adult/php/youporn.php?query=1,".$link.",release";;
  	if ($title <> "All") {
  	echo '
  	<item>
  		<title>'.$title.'</title>
