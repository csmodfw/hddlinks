...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/slutload.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
foreach($videos as $video) {
    ...
    $t3=explode('<',$t2[1]);
  	...
  	$link=$host."/scripts/adult/php/slutload.php?query=1,".$link.",release";
  	if ($title) {
  	echo '
  	<item>
  		<title>'.$title.'</title>
