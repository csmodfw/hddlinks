...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/incestvidz.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
foreach($videos as $video) {
    ...
    $link=$t1[0];
  	...
  	$link=$host."/scripts/adult/php/incestvidz.php?query=1,".$link.",release";
  	if ($title) {
  	echo '
  	<item>
  		<title>'.$title.'</title>
