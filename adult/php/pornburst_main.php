...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host; ?>/scripts/adult/php/pornburst.php?query=1," + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/pornburst.php?query=1,https://www.pornburst.xxx/,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
