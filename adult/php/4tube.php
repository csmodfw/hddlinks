...
//http://www.4tube.com/tags/amateur?p=2
$search3  = $search."?p=".$page."&sort=date";  //http://www.4tube.com/videos?p=2&sort=date
  $ch = curl_init();
...
$videos = explode('data-video-uuid="', $html);
...
foreach($videos as $video) {
    ...
    $link = $host."/scripts/adult/php/4tube_link.php?file=".$link;
    //http://img02.redtubefiles.com/_thumbs/0000350/0350855/0350855_009m.jpg

    $t1=explode('duration-top">',$video);
    //$t2=explode('>',$t1[1]);
    $t3=explode("<",$t1[1]);
    $data=$t3[0];
    //$data = trim(str_between($video,'datetime="PT9M36S">',"<"));
