...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/adult/php/milfzr.php?query=1,"; ?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<script>
...
function str_between($string, $start, $end){ 
	...
	return substr($string,$ini,$len); 
  	...
  	$link=$host."/scripts/adult/php/milfzr.php?query=1,http://milfzr.com,release";
  	echo '
  	<item>
  		<title>New</title>
  		<link>'.$link.'</link>
...
$l="http://milfzr.com";
  ...
  $html = curl_exec($ch);
  curl_close($ch);
  //http://milfzr.com/category/brother-sister-porn
...
foreach($videos as $video) {
    ...
    $t3=explode('<',$t2[1]);
  	...
  	$link=$host."/scripts/adult/php/milfzr.php?query=1,".$link.",release";;
  	if ($title <> "All") {
  	echo '
  	<item>
  		<title>'.$title.'</title>
