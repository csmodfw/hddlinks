...
if($query) {
   ...
   if ($tip == "release") {
     ...
     if ($page>1)
     $search2="https://www.youporn.com/search/?query=".$search3."?page=".$page;
     else
     $search2="https://www.youporn.com/search/?query=".$search3;
     $tip="search";
   }
}
if ($tip=="release") {
...
$videos = explode("class='video-box four-column", $html);
unset($videos[0]);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "https://www.youporn.com".$t2[0];
