...
if($page>1) {
    if($search) {
        $search3 = "https://www.pornhub.com/video?".$search."&page=".$page;
    } else {
        $search3 = "https://www.pornhub.com/video?".$search."&page=".$page;
    }
} else {
    if($search) {
        $search3 = "https://www.pornhub.com/video?".$search;
    } else {
        $search3 = "https://www.pornhub.com/video?".$search;
    }
}
 ...
 $search3="https://www.pornhub.com/video/search?search=".$search1."&page=".$page;
