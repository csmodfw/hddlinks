...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/trailer/php/cinemagia_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/trailer/php/cinemagia_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
