...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/tv/sport/digi_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/sport/digi_link.php?file='.urlencode($link).'";
    movie=getUrl(url);
    cancelIdle();
