...
$videos = explode('class="cele-item">', $html);
unset($videos[0]);
...
foreach($videos as $video) {
    ...
    $link="http://127.0.0.1/cgi-bin/scripts/util/translate1.cgi?stream,Rtmp-options:";
    $link=$link."-y ".$y." -a vod/llnw -W http://ivm.gsp.ro/swf/player40.swf -p ".$p.",rtmp://vod1.gsp.ro/vod/llnw";
