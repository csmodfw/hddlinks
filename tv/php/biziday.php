...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/clip/php/biziday_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
if ($page==1)
  $html = file_get_contents("http://www.biziday.ro/news/inregistrari/");
else
  $html = file_get_contents("http://www.biziday.ro/news/inregistrari/page/".$page."/");
...
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/php/biziday_link.php?file='.$link.'";
    movie=getUrl(url);
    cancelIdle();
