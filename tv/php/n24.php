...
include ("../../common.php");
//http://www.n24plus.ro/arhiva-video/1
$html = file_get_contents("http://www.n24plus.ro/arhiva-video/".$page);
if($page > 1) { ?>
...
$videos = explode('<ul class="article-videos-playlist"', $html);
...
foreach($videos as $video) {
    ...
    $title=str_replace(urldecode("%C8%99"),"s",$title);
    $title=str_replace(urldecode("%C8%9A"),"T",$title);
    */
