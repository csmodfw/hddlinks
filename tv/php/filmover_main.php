...
if($page > 1) {
	$html = file_get_contents("http://iptv.filmover.com/page/".$page."/");
} else {
  $page = 1;
  $html = file_get_contents("http://iptv.filmover.com/");
}
...
foreach($videos as $video) {
    ...
    $title=trim($t2[0]);
	if ($title <> ""){
    $link = 'http://127.0.0.1/cgi-bin/scripts/tv/php/filmover.php?file='.urlencode($link).','.urlencode($title);
    echo '
    <item>
