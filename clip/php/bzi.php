...
if (userInput == "two" || userInput == "2")
	{
     showIdle();
     url="<?php echo $host; ?>" + "/scripts/clip/php/biz_link.php?file=" + getItemInfo(getFocusItemIndex(),"download");
     movie=getUrl(url);
     cancelIdle();
...
foreach($videos as $video) {
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/clip/php/biz_link.php?file='.urlencode($link).'";
    movie=getUrl(url);
    cancelIdle();
