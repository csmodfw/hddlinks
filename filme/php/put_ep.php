...
//$cookie="D:/";
 ...
 $videos = explode('class="episode episode_series_link', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $episod=$m[2];
   ...
   $image1=$image;
   $link2=$host."/scripts/filme/php/put_link.php?file=".urlencode($link_ep).",".urlencode(str_replace(",","^",$title1)).",".urlencode(str_replace(",","^",$series_title_no_year)).",".$id_t.",series,".urlencode($image);
   if ($video) {
     echo '
     <item>
