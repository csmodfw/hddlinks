...
<channel>
	<title>filmeserialeonline - categorii</title>
	<menu>main menu</menu>
...
$l="http://www.filmeserialeonline.org/filme-online/";
  ...
  $html = curl_exec($ch);
  curl_close($ch);
$link="http://www.filmeserialeonline.org/filme-online/";
$link = $host."/scripts/filme/php/filmeserialeonline.php?query=,".$link;
$title="Filme Noi";
    	echo '
    	<item>
    		<title>'.$title.'</title>
    	...
    	';
//$html = str_between($html,'class="cat-item cat-item-1">',"</ul" );
