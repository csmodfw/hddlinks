...
$c=count($r["seasons"]);
for ($k=0;$k<$c;$k++) {
  $season= $r["seasons"][$k]["num"];
  $c1=count($r["seasons"][$k]["episodes"]);
  for ($z=0;$z<$c1;$z++) {
   $name = $r["seasons"][$k]["episodes"][$z]["name"];
   $image= "http://image.tmdb.org/t/p/w300".$r["seasons"][$k]["episodes"][$z]["img"];
   $ep_nr=$season."x".($z+1) ;
   $title=$ep_nr." - ".$name;
   $year=$r["seasons"][$k]["episodes"][$z]["air_date"];
   if ($title) {
