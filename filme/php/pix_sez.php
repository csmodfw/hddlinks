...
//$cookie="D:/";
  //echo $html;
$html=str_between($html,'id="szzz">','</div');
$image1=$image;
...
foreach($videos as $video) {
  ...
  //$t1=explode('>',$video);
  //season-1-episode-3
   $link2=$host."/scripts/filme/php/pix_ep.php?file=".urlencode($link1).",".urlencode(str_replace(",","^",$title1)).",".urlencode(str_replace(",","^",$series_title_no_year)).",".$id_t.",series,".urlencode($image);
   if ($video) {
     echo '
     <item>
