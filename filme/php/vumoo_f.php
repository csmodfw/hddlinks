...
id=getItemInfo(getFocusItemIndex(),"id");
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/vumoo_f_add.php?mod=add," + urlEncode(movie) + "," + tit + "," + urlEncode(img) + "," + urlEncode(year) + "," + urlEncode(id);
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
if ($tip=="search")
   ...
   $requestLink = "http://vumoo.li/videos/category/".str_replace(" ","%20",$link)."/?page=".$page."";
//echo $requestLink;
