...
if ($tip=="movie")
$l="https://".$server."/api/v1/user/list/mylist?type=movies&sort=added_on";
else
$l="https://".$server."/api/v1/user/list/mylist?type=tv&sort=added_on";
...
for ($k=0;$k<$c;$k++) {
  $title= $r[$k]["title"];
  $year = $r[$k]["year"];
  $image= "http://image.tmdb.org/t/p/w300".$r[$k]["poster"];
  //echo $r[$k]["permalink"];
  $imdb=$r[$k]["imdb_id"];
   if ($title) {
