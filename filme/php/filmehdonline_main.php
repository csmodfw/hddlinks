...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/filme/php/filmehdonline.php?query=search,1,"; ?>" + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<channel>
	<title>filmehdonline - categorii</title>
	<menu>main menu</menu>
<?php
...
$link="http://www.filmehdonline.org/";
	echo '
	<item>
	<title>Filme noi</title>
	<link>'.$host.'/scripts/filme/php/filmehdonline.php?query=release,1,'.$link.'</link>
