...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/filme/php/vumoo_f.php?page=1,search,";?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
...
<?php
  ...
  $link = $host."/scripts/filme/php/vumoo_f_fav.php";
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
  ...
  ';
  $link1=$host."/scripts/filme/php/vumoo_f.php?page=1,release,new+releases,new+releases,";
  $title="Recent";
	echo '
	<item>
	<title>'.$title.'</title>
...
foreach($videos as $video) {
    $t0 = explode('<a href="/videos/category/',$video);
    $t1 = explode('"', $t0[1]);
    $link = $t1[0];
    $t2 = explode('>', $t1[1]);
    $t3 = explode('<', $t2[1]);
    $title = $t3[0];
  $link1=$host."/scripts/filme/php/vumoo_f.php?page=1,release,".urlencode($link).",".urlencode($title);
    if ($title) {
	echo '
	<item>
	<title>'.$title.'</title>
