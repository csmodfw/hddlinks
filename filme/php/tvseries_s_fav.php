...
>
    ...
    2 = sterge de la favorite,  right for more. Reincarcati pagina pentru a vedea rezultatul
		</text>
...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/tvseries_s_add.php?mod=delete*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
if (file_exists("/data"))
  $f= "/data/tvseries_s.dat";
else
  $f="/usr/local/etc/tvseries_s.dat";
if (file_exists($f)) {
