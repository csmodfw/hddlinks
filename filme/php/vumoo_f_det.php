...
//http://vumoo.li/popup/movie_info/88871
...
$requestLink = "http://vumoo.li/popup/movie_info/".$link;
...
$imdb="Rating: ".trim(str_between($html,'movie_rating" data-score="','"'));
//$imdb="";
$gen="";
$durata="";


$cast="Stars: ".str_between($html,'Stars','</div>');
$cast = trim(preg_replace("/(<\/?)(\w+)([^>]*>)/e","",$cast));
$desc=trim(str_between($html,'<p>',"<"));
