...
<?php
//echo $l_sub;
//$l_sub="https://subs.ro/cautare/?search-text=Farscape&in=name&antispam=0f0d3deec25992e4af76492010f07153d82ad2d0";
//$l_sub="https://subs.ro/ajax/search/?search-text=star+trek&amp;in=name&amp;antispam=0f0d3deec25992e4af76492010f07153d82ad2d0";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $l_sub);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 10.0; rv:55.0) Gecko/20100101 Firefox/55.0');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION  ,1);
  curl_setopt ($ch, CURLOPT_REFERER, "https://subs.ro/subtitrari/");
  ...
  curl_close($ch);
  //echo $h;
//$html=str_between($html,'<ul class="items">','</ul');
...
foreach($videos as $video) {
  ...
  <item>
  <title>'.$title.'</title>
  <link>http://127.0.0.1/cgi-bin/scripts/filme/php/subs.php?query='.$link.','.$search.'</link>
