...
ret;
	...
	<searchLink>
	  <link>
	    <script>"<?php echo $host."/scripts/filme/php/gomovies_f.php?page=1,search,";?>" + urlEncode(keyword) + "," + urlEncode(keyword);</script>
	  </link>
	</searchLink>
<fs>
...
foreach($videos as $video) {
  ...
  $episod="";
   ...
   $link2=$host."/scripts/filme/php/gomovies_link.php?file=".urlencode($link1).",".urlencode(str_replace(",","^",$title)).",".$season.",".$episod.",movie,".urlencode($image);
   if ($title) {
     echo '
     <item>
