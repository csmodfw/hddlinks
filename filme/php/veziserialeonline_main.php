...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/veziserialeonline_add.php?mod=add*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
<link>'.$host.'/scripts/filme/php/veziserialeonline_fav.php</link>
...
foreach($videos as $video) {
    ...
    $data=$title;
    if ($link1 <> "") {
		$link = $host.'/scripts/filme/php/veziserialeonline.php?file='.$link1.",".urlencode($title);
