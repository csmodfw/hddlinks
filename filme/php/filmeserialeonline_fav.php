...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/filmeserialeonline_seriale_add.php?mod=delete*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
ret;
  ...
  <channel>
    ...
    <title>filmeserialeonline - seriale favorite</title>
...
if (file_exists("/data"))
  $f= "/data/filmeserialeonline.dat";
else
  $f="/usr/local/etc/filmeserialeonline.dat";
if (file_exists($f)) {
