...
$a1=explode('class="thumb pull-left">',$html);
$html=$a1[1];
$t1=explode('url=',$a1[1]);
$t2=explode('"',$t1[1]);
$img=$t2[0];
$img=str_replace("https","http",$img);
$t1=explode('Release:',$html);
$t2=explode('>',$t1[1]);
$t3=explode("<",$t2[1]);
$year="Year: ".trim($t3[0]);


$imdb="IMDB Rating: ".trim(str_between($html,"IMDB Rating:",'<'));
$t3=explode('Genre:',$t1[1]);
$t4=explode("</p",$t3[1]);
