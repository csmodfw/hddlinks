...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/gold_add.php?mod=delete*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
ret;
  ...
  <channel>
    ...
    <title>filme-seriale.gold - seriale favorite</title>
...
foreach ($arr as $key => $val) {
  ...
  $link = $host."/scripts/filme/php/gold.php?file=".$l.",".urlencode(str_replace(",","^",$title));
    echo '
    <item>
