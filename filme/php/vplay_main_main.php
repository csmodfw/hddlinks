...
<searchLink>
 <link>
 <script>"<?php echo $host."/scripts/filme/php/vplay_search.php?query="; ?>" + urlEncode(keyword);</script>
 </link>
</searchLink>
<logon>
 <link>
...
foreach($videos as $video) {
  ...
  <item>
  <title>'.$title.'</title>
  <link>'.$host.'/scripts/filme/php/vplay_main.php?query=1,'.$link.','.urlencode($title).'</link>
