...
//http://desenanimatdublat.blogspot.ro
//$search1=urlencode($search);
if ($page==1)
  $l="http://desenanimatdublat.blogspot.ro/";
else
  $l="http://desenanimatdublat.blogspot.ro/search?updated-max=".urlencode($search)."&max-results=32";
  //echo $l;
