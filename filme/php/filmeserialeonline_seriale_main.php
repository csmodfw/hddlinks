...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/filme/php/filmeserialeonline_seriale_add.php?mod=add*" + getItemInfo(getFocusItemIndex(),"link1") + "*" + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
if ($page == 1) {
  ...
  $link = $host."/scripts/filme/php/filmeserialeonline_fav.php";
  echo '
  <item>
  <title>'.$title.'</title>
  <link>'.$link.'</link>
