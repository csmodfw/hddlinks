...
>
    ...
    2= adauga la favorite, 4/6 salt -+50
		</text>
  	...
  	<text  redraw="yes" align="center" offsetXPC="0" offsetYPC="90" widthPC="100" heightPC="8" fontSize="17" backgroundColor="10:105:150" foregroundColor="100:200:255">
		...
		<image  redraw="yes" offsetXPC=60 offsetYPC=27 widthPC=30 heightPC=55>
...
';
$l="http://www.playfs.com/lista-noua-seriale-online-subtitrate.html";
  $ch = curl_init();
  ...
  //$html= decode_entities($html);
	...
	foreach($videos as $video) {
		...
		$t2=explode('"',$t1[1]);
		$img="http:".$t2[0];
		//http://play.playfs.com/wp-content/uploads/2010/05/90210-2008%E2%80%93--200x300.jpg
        $img=urlencode($img);
